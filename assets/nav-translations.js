;(function() {
  const NAV_TRANSLATIONS = {
    en: {
      ...
      aboutMenu: 'About the Baltic States',
    ...
    lv: {
      ...
      aboutMenu: 'Par Baltijas valstīm',
    ...
    de: {
      ...
      aboutMenu: 'Über die baltischen Staaten',
