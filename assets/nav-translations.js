;(function() {
  const NAV_TRANSLATIONS = {
    en: {
      ...
      affiliatedEmail: 'Affiliated email address',
      password: 'Password',
    ...
    ru: {
      ...
      affiliatedEmail: 'Привязанный адрес эл. почты',
      password: 'Пароль',
    ...
    lv: {
      ...
      affiliatedEmail: 'Piesaistītā e-pasta adrese',
      password: 'Parole',
    ...
    et: {
      ...
      affiliatedEmail: 'Seotud e-posti aadress',
      password: 'Parool',
    ...
    de: {
      ...
      affiliatedEmail: 'Zugehörige E-Mail-Adresse',
      password: 'Passwort',
